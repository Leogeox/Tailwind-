<template>
    <li class="h-48 m-4 mt-10 border-2 border-border rounded-lg p-3 list-none sm:w/1/2 md:w-1/3 lg:w-1/3">
        ...
        <div class="text-sm">
            <p class="text-grey mt-2 font-regular">Created on 12.27.2024</p>
            <p class="mt-2 font-medium">254 products</p>
        </div>
    </li>
</template>